...
class ConcertController
{
    ...
    // CREATE
    public function createConcert($name, $location, $date, $price)
    {
        $stmt = $this->conn->prepare("INSERT INTO concerts (name, location, date, price) VALUES (?, ?, ?, ?)");
        return $stmt->execute([$name, $location, $date, $price]);
    }
    ...
    // UPDATE
    public function updateConcert($id, $name, $location, $date, $price)
    {
