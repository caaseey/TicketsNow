...
<head>
  ...
  <title>Eladio Carrión | Tickets Now</title>
</head>
...
<nav class="navbar">
  ...
  <!-- HEADER -->
  <header class="banner-header" style="background-image: url('../../../media/img/concert_banners/eladio_carrion.jpg');">
    ...
    <div class="ticket">
      <div class="ticket-info">
        ...
        <div class="ticket-details">
          <p>mié · 21:00</p>
          <p>Eladio Carrión - Perreo Espacial Tour</p>
    ...
    <div class="ticket">
      <div class="ticket-info">
        ...
        <div class="ticket-details">
          <p>sáb · 21:00</p>
          <p>Eladio Carrión - Perreo Espacial Tour</p>
          <p>Ciudad de México - Auditorio Nacional</p>
        </div>
      </div>
      <a href="../tickets.php"><button>ENTRADAS</button></a>
    </div>
