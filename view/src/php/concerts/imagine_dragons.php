...
<head>
  ...
  <title>Imagine Dragons | Tickets Now</title>
</head>
...
<nav class="navbar">
  ...
  <!-- HEADER -->
  <header class="banner-header" style="background-image: url('../../../media/img/concert_banners/imagine_dragons.jpg');">
    ...
    <div class="ticket">
      <div class="ticket-info">
        ...
        <div class="ticket-details">
          <p>dom · 21:00</p>
          <p>Imagine Dragons - Evolve Again Tour</p>
          <p>Cantabria - Campos de Sport de El Sardinero</p>
        </div>
      </div>
    ...
    <div class="ticket">
      <div class="ticket-info">
        ...
        <div class="ticket-details">
          <p>mié · 20:30</p>
          <p>Imagine Dragons - Evolve Again Tour</p>
          <p>Valencia - Estadi Ciutat de València</p>
        </div>
      </div>
      <a href="../tickets.php"><button>ENTRADAS</button></a>
    </div>
    ...
    <div class="ticket">
      <div class="ticket-info">
        ...
        <div class="ticket-details">
          <p>mar · 20:00</p>
          <p>Imagine Dragons - Evolve Again Tour</p>
          <p>Madrid - Cívitas Metropolitano</p>
        </div>
      </div>
      <a href="../tickets.php"><button>ENTRADAS</button></a>
    </div>
    ...
    <div class="ticket">
      <div class="ticket-info">
        ...
        <div class="ticket-details">
          <p>mar · 19:30</p>
          <p>Imagine Dragons - Evolve Again Tour</p>
          <p>Santiago de Chile - Estadio Nacional</p>
        </div>
      </div>
      <a href="../tickets.php"><button>ENTRADAS</button></a>
    </div>
