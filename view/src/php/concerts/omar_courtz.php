...
<head>
  ...
  <title>Omar Courtz | Tickets Now</title>
</head>
...
<body>
  ...
  <!-- HEADER -->
  <header class="banner-header" style="background-image: url('../../../media/img/concert_banners/omar_courtz.jpg');">
  ...
  <div class="ticket">
    <div class="ticket-info">
      ...
      <div class="ticket-details">
        <p>mié · 21:00</p>
        <p>Omar Courtz - Asia Tour</p>
        <p>Lugo - Pazo Universitario dos Deportes</p>
      </div>
    </div>
